...
class Scheduler<T> {
    ...
    public Scheduler(TreeMap<Date, T> timestamps) {
    ...
    public T next() {
        ...
        return timestamps.get(timestamps.ceilingKey(present));
    }

    public T last() {
        Date present = new Date();
        return timestamps.get(timestamps.floorKey(present));
    }

    public ArrayList<T> getAll(Date begin, Date end) {
        ArrayList<T> list = new ArrayList<>();
        timestamps.subMap(timestamps.ceilingKey(begin), true, timestamps.floorKey(end), true)
                .keySet().forEach(key -> list.add(timestamps.get(key)));
        return list;
    }
